...
test("can get employee list", async () => {
    const conn = await getConnection();
...
test("can get invoice list", async () => {
    const conn = await getConnection();
...
test("can get invoice item list", async () => {
    const conn = await getConnection();
...
test("can get media type list", async () => {
    const conn = await getConnection();
...
test("can get sale record list", async () => {
    const conn = await getConnection();
